  ...
  return (
    <section className="max-w-6xl w-full mx-auto px-2 my-16 flex flex-col min-[840px]:flex-row items-center gap-8 min-[840px]:gap-0">
      ...
      >
        ...
        <div>
          <h3 className='text-lg md:text-2xl font-lilita-one text-title-black-38/70 uppercase'>Horário de funcionamento</h3>
          <p className='text-white/85 w-36 sm:w-auto'>Segunda<span className='hidden md:inline'>-feira</span> a sexta<span className='hidden md:inline'>-feira</span>: <span className='font-black'>17h00 - 23h00</span></p>
          <p className='text-white/85 w-36 sm:w-auto'>Sábado a Domingo: <span className='font-black'>18h00 - 23h00</span></p>
        </div>
      </div>
      ...
      <div className='min-[840px]:px-8 text-center md:text-start'>
        ...
        <p className='text-[2.563rem] md:text-3xl text-red-layout font-lilita-one uppercase'>#empireburger</p>
      </div>
    </section>
  )
}