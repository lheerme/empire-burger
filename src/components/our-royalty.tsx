...
export function OurRoyalty() {
  ...
  return (
    <section id="our-royalty" className="max-w-6xl w-full mx-auto px-6">
      <div className="mb-4">
          ...
          {data?.map((testimonial, index) => (
            ...
            >
              <p
                ...
                className="text-title-black-60 line-clamp-4"
              >
              ...
              <div className="flex items-center gap-2">
                <img
                  ...
                  alt={`foto do(a) ${testimonial.name}`}
                  className="size-12 rounded-full object-cover"
                />
                <div className="flex flex-col">
                  <h4 className="text-title-black-38/90 min-[380px]:text-lg uppercase font-lilita-one">
                    {testimonial.name}
                  </h4>
                  <p className="text-title-black-38/70 text-xs">
                    {testimonial.name}
                  </p>
                </div>
              </div>
