...
export function Header() {
  ...
  return (
    <header
      className={twMerge(
        'fixed w-full border-b-[1px] border-[#3C210C26] z-[2] transition-colors',
        isScrolled ? 'bg-beige' : 'backdrop-blur-md'
      )}
    >
      <div className="max-w-6xl w-full mx-auto py-3.5 px-6 flex items-center justify-between gap-2">
        <a href="#" className="block w-fit shrink-0">
          <img
            ...
            className="min-[390px]:w-auto w-48"
          />
        </a>
        ...
        <nav
          className={twMerge(
            ...
            isHamburgerChecked &&
              'flex flex-col items-center justify-center gap-10 absolute w-full h-dvh top-0 left-0 bg-beige'
          )}
        >
          <ul
            className={twMerge(
          ...
          <div className="min-[1040px]:hidden">
            <div className="flex flex-col items-center gap-3">
              <div className="flex items-center gap-3">
                <a
                  href="#"
                  className="size-10 flex items-center justify-center hover:opacity-80 hover:transition-opacity shrink-0 bg-red-layout rounded-md"
                >
              ...
              <button
                type="button"
                className="flex bg-yellow-layout rounded-md gap-2 py-1 px-4 text-base text-title-black-87 font-bold shadow-md"
              >
        ...
        <div className="min-[1040px]:flex hidden items-center gap-3">
          <a
            href="#"
            className="block w-fit hover:opacity-80 hover:transition-opacity shrink-0"
          >
            <img src={iFoodLogo} alt="iFood logo" />
          </a>
          <a
