...
export function SpecialOffers() {
  return (
    <section id="offers" className="max-w-6xl w-full mx-auto px-6">
      <h2 className="font-lilita-one text-2xl md:text-3xl text-title-black-38/90 uppercase">
        Ofertas especiais
      </h2>
      <p className="text-title-black-38/70">
      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-3 grid-rows-3 md:grid-rows-2 gap-4 lg:gap-[30px]">
        <div className="w-full max-w-[770px] h-[211px] md:h-[430px] relative group overflow-hidden rounded-2xl cursor-default md:row-span-2 md:col-span-2">
          ...
          <div className="size-full relative z-[1] flex justify-between py-4 px-5">
            <div>
              <h3 className="font-lilita-one text-xl md:text-2xl text-white uppercase">
                Burger imperial+batata
              </h3>
              <p className="text-white/70 text-lg">250kg</p>
            </div>

            <p className="text-white/70 text-xs md:text-2xl self-end w-12 md:w-24">
              Apenas{' '}
              <span className="text-white font-lilita-one text-xl md:text-[2.625rem]">
                HOJE
              </span>
            </p>
          </div>
        ...
        <div className="w-full md:max-w-[370px] h-[211px] md:h-[200px] relative group overflow-hidden rounded-2xl cursor-default">
          ...
          <div className="size-full relative z-[1] flex justify-between py-4 px-5">
            <div>
              <h3 className="font-lilita-one text-xl md:text-2xl text-title-black-38/90 uppercase leading-none">
                batata
              </h3>
              <p className="text-title-black-38/70 leading-none text-lg">
                150kg
              </p>
            </div>
          </div>
